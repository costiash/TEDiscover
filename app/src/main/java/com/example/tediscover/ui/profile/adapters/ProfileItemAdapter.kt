...
class ProfileItemAdapter
    : ListAdapter<TalkItem, ProfileItemAdapter.TalkItemViewHolder>(DiffCallback) {
    ...
    inner class TalkItemViewHolder(private var binding: ProfileItemBinding): RecyclerView.ViewHolder(binding.root) {
        fun bind(TalkItem: TalkItem) = with(itemView) {
            ...
            binding.moreBtn.setOnClickListener {
                (context as TedActivity).showLikeMenu(binding.moreBtn, R.menu.popup_menu, TalkItem)
            }
