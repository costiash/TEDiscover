package com.example.tediscover.ui.discover.adapters
...
import com.example.tediscover.ui.discover.fragments.DiscoverFeedFragmentDirections
import com.example.tediscover.ui.models.EventItem


class SearchEventAdapter : PagingDataAdapter<EventItem, SearchEventAdapter.ViewHolder>(
    REPO_COMPARATOR
) {
    ...
    class ViewHolder(private var binding: EventItemBinding) :
        ...
        fun bind(item: EventItem) = with(itemView) {
            ...
            itemView.setOnClickListener {
                ...
                val action = DiscoverFeedFragmentDirections.actionDiscoverFeedFragmentToVideoDetailFragment(item)
